...
const AdminNav = () => {
  ...
  const navItems = [
    { name: "Home", href: "/admindashborder" },
    { name: "About Us", href: "/about" },
    { name: "Contact Us", href: "/contact" },
    // { name: "Login", href: "./login" },
    { name: "Search", href: "./SearchPage" },

    { name: "victim", href: "./victim-tools" },
    { name: "case", href: "./case-tools" },

    { name: "Search Cases", href: "./AdminCase-search" },
    // { name: "analyst ", href: "./analyst-tools" },
